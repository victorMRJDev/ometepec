  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.success) {
        ...
        setModalMessageRegister('Permiso agregado correctamente')
        ...
        setModalMessageRegister('Error al registrar el permiso')
        setIsModalRegisterOpen(true)

        setFormData((prev) => ({
          ...prev,
          folioUnico: updateFormData.folioUnico,
          numSerie: updateFormData.numSerie,
          numMotor: updateFormData.numMotor,
          marca: updateFormData.marca,
          yearModelo: updateFormData.yearModelo,
          color: updateFormData.color,
          rfcSolicitante: updateFormData.rfcSolicitante,
          domicilio: updateFormData.domicilio,
          nombres: updateFormData.nombres,
          apellidoPaterno: updateFormData.apellidoPaterno,
          apellidoMaterno: updateFormData.apellidoMaterno,
          status: updateFormData.status,
          importe: updateFormData.importe,
          rutaIne: updateFormData.rutaIne,
          rutaEstSanguineo: updateFormData.rutaEstSanguineo,
          rutaConstSitFiscal: updateFormData.rutaConstSitFiscal,
          idUser: updateFormData.idUser
        }))
      }
    } catch (err) {
      setModalTypeRegister('error')
      setModalMessageRegister('Error al enviar los datos. Por favor, intente de nuevo', formData)
      setIsModalRegisterOpen(true)
      console.error(err)
    }
  }
