...
//         <div>
//           <Button onClick={navigate('/addUser')}>Agregar Usuario</Button>
//         </div>
...
export const ListUsersComp = ({ requests }) => {
  ...
  //   // Después de agregar un usuario, re-obtenemos la lista de usuarios
  //   await fetchUserList()
  // }
  return (
    <>
      <div className="max-w-4xl mx-auto bg-white rounded-md shadow-lg overflow-auto max-h-screen overflow-y-auto">
        <h2 className="text-2xl font-encodesans-medium  text-gray-800 border-b p-6">
          Lista de usuarios del sistema{' '}
        </h2>

        <div>
          <Button onClick={() => navigate('/addUser') } primary>
            Agregar Usuario
          </Button>
        </div>
      ...
      <ModalBasicUser
        ...
        title={modalContent.title}
        size="large"
        children={modalContent.data && <ModalContentUser {...modalContent.data} />}
      />
      <ModalBasicUser />
    </>
  )
